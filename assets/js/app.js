...
skins.init("[\"/json/skins/default.json\"]");
  ...
  methods: {
    init: {
      ...
      endpoints: function() {
        ...
        if (eclipse.methods.get_params("q") == "repo") {
          paramURL = window.location.href + eclipse.methods.get_params("url").patch();
          if (paramURL) {
              ...
              },
              {
                ...
                onClick: function() {
                  ...
                  if (gameURL.indexOf("googleapis.com") != -1) {
                    try {
                      if (GoogleDrive.getSigninStatus() == true) {
                        gameURL = gameURL + "&token=" + gapi.auth.getToken().access_token + "&ext=" + game.system.patch().toLowerCase();
                      } else {
                        console.alert("This games requires that your Google Drive account is linked with Eclipse. Please go into Settings and log in to Google Drive to play this game.");
                      }
                    } catch (err) {
    ...
    skins: {
      ...
      addSkin: function(url) {
        isDupe = Boolean(skins.list().search(url)+1);
        if(isDupe) {
      ...
      reset: {
        ...
        skins: function() {
          eclipse.dialog.confirm('Are you sure you want to clear your installed skins? This cannot be undone.', "Reset Skins?", function() {
            localStorage.setItem("skins", '["/json/skins/default.json"]');
        ...
        if (gamesList.length > 0) {
          for (i = 0; i < gamesList.length; i++) {
            ...
            library += `<li class="swipeout">
                        <a class="game-item swipeout-content item-content item-link" onclick="eclipse.methods.emu.systems.${game.system.toLowerCase()}.init({url: '${btoa(game.link.patch())}'}); DiscordLink.set('${game.system.patch().toLowerCase()}','${game.name.patch()}');" data-index="${i}" data-name="${game.name}" data-url="${game.link}" data-system="${game.system}">
          ...
          content: `<div class="page-content popup">
                      <div style="padding: 25px;padding-top: 0">
                        <div style="width: 100%; overflow-x: hidden;" class="block">
                          <h1 style="color:#333;margin:0;font-size:42px;text-align:center">Welcome to OpenEMU.</h1><br>
          ...
          content: `<div class="page-content popup">
                            <div class="block">
                                <center>
                                    ...
                                    <p>To use OpenEMU, you must agree to the following Terms of Service. Please read and accept it in order to use OpenEMU.</p>
                                    <p><b>By using OpenEMU, you agree to take full responsibility to any repercussions that my follow.</b></p>
          ...
          content: `<div class="page-content popup">
                            <div class="block">
                                <center>
                                    ...
                                    <p>You can customize what OpenEMU would look like using skins. You can change this later or add your own in Settings.</p>
                                    <br>
                                    <div id="skinSelector">
                                        <img onerror="javascript:this.src='assets/img/default-cover.png'" onclick="skins.set('/json/skins/default.json');eclipse.methods.skins.addSkin('/json/skins/default.json')" style="cursor:pointer;width:80px;height:80px;border-radius:21%" src="./assets/img/skin/red.png">
                                        <txt style="visibility:hidden">---</txt>
                                        <img onerror="javascript:this.src='assets/img/default-cover.png'" onclick="skins.set('/json/skins/teal.json');eclipse.methods.skins.addSkin('/json/skins/teal.json')" style="cursor:pointer;width:80px;height:80px;border-radius:21%" src="./assets/img/skin/teal.png">
                                        <txt style="visibility:hidden">---</txt>
                                        <img onerror="javascript:this.src='assets/img/default-cover.png'" onclick="skins.set('/json/skins/blue.json');eclipse.methods.skins.addSkin('/json/skins/blue.json')" style="cursor:pointer;width:80px;height:80px;border-radius:21%" src="./assets/img/skin/blue.png">
                                        <txt style="visibility:hidden">---</txt>
                                        <img onerror="javascript:this.src='assets/img/default-cover.png'" onclick="skins.set('/json/skins/green.json');eclipse.methods.skins.addSkin('/json/skins/green.json')" style="cursor:pointer;width:80px;height:80px;border-radius:21%" src="./assets/img/skin/green.png">
                                        <txt style="visibility:hidden">---</txt>
                                        <img onerror="javascript:this.src='assets/img/default-cover.png'" onclick="skins.set('/json/skins/grey.json');eclipse.methods.skins.addSkin('/json/skins/grey.json')" style="cursor:pointer;width:80px;height:80px;border-radius:21%" src="./assets/img/skin/grey.png">
                                        <txt style="visibility:hidden">---</txt>
                                        <img onerror="javascript:this.src='assets/img/default-cover.png'" onclick="skins.set('/json/skins/magenta.json');eclipse.methods.skins.addSkin('/json/skins/magenta.json')" style="cursor:pointer;width:80px;height:80px;border-radius:21%" src="./assets/img/skin/magenta.png">
                                        <txt style="visibility:hidden">---</txt>
                                        <img onerror="javascript:this.src='assets/img/default-cover.png'" onclick="skins.set('/json/skins/orange.json');eclipse.methods.skins.addSkin('/json/skins/orange.json')" style="cursor:pointer;width:80px;height:80px;border-radius:21%" src="./assets/img/skin/orange.png">
                                        <txt style="visibility:hidden">---</txt>
                                        <img onerror="javascript:this.src='assets/img/default-cover.png'" onclick="skins.set('/json/skins/iGBAModern.json');eclipse.methods.skins.addSkin('/json/skins/iGBAModern.json')" style="cursor:pointer;width:80px;height:80px;border-radius:21%" src="./assets/img/skin/igba.jpeg">
                                        <txt style="visibility:hidden">---</txt>
                                        <img onerror="javascript:this.src='assets/img/default-cover.png'" onclick="skins.set('/json/skins/iGBALegacy.json');eclipse.methods.skins.addSkin('/json/skins/iGBALegacy.json')" style="cursor:pointer;width:80px;height:80px;border-radius:21%" src="./assets/img/skin/igba.png">
                                        <txt style="visibility:hidden">---</txt>
                                    </div>
          ...
          content: `<div class="page-content popup">
                            <div class="block">
                                <center>
                                    ...
                                    <p>OpenEMU can optionally be linked with your Google Drive account, allowing you to add ROMs stored in Google Drive with ease.</p>
          ...
          content: `<div class="page-content popup">
                            <div class="block">
                                <center>
                                    ...
                                    <p>OpenEMU has been configured successfully and is ready for some games! Here are some ways to get some:</p>
      ...
      update: function() {
        ...
        eclipse.popup.create({
          content: `<div class="page-content popup">
                            <div class="block">
                                <center>
                                    <div class="row"><h1 style="color:#333;margin:0;width:80%;font-size:42px;;padding-left:10%">Welcome to OpenEMU 2.0!</h1></div>
          ...
          if (gamesList.length > 0) {
            ...
            for (i = 0; i < gamesList.length; i++) {
              ...
              library += '<div class="col-50 tablet-25 desktop-20">' +
                '<a onclick="eclipse.methods.emu.systems.' + game.system.toLowerCase() + '.init({url: \'' + btoa(game.link.patch()) + '\'}); DiscordLink.set(\'' + game.system.patch().toLowerCase() + '\',\'' + game.name.patch() + '\');" href="#" class="game-card" data-index="' + i + '" data-name="' + game.name + '">' +
                '<div class="card">' +
        ...
        pageInit: function(e, page) {
          ...
          if (gamesList.length > 0) {
            for (i = 0; i < gamesList.length; i++) {
              var game = JSON.parse(gamesList[i]);
              library += `<li class="swipeout">
                        <a class="game-item swipeout-content item-content item-link" onclick="eclipse.methods.emu.systems.${game.system.toLowerCase()}.init({url: '${btoa(game.link.patch())}'}); DiscordLink.set('${game.system.patch().toLowerCase()}','${game.name.patch()}');" data-index="${i}" data-name="${game.name}" data-link="${game.link}" data-system="${game.system}">
                          <div class="item-media">
